...
declare interface $Fetch<DefaultT = unknown, DefaultR extends FetchRequest = FetchRequest> {
...
declare function loadOptions(overrideConfig?: NitroConfig): Promise<NitroOptions>;
declare function defineNitroConfig(config: NitroConfig): NitroConfig;

export { $Fetch, InternalApi, MatchedRoutes, MiddlewareOf, Nitro, NitroConfig, NitroHooks, NitroOptions, NitroPreset, NitroRouteRule, NitroWorker, ServerMiddleware, TypedInternalResponse, ValueOf, build, copyPublicAssets, createDevServer, createNitro, defineNitroConfig, loadOptions, prepare, prerender, scanMiddleware, writeTypes };
