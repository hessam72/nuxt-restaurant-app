...
async function prepareDevServerEntry(ctx) {
  ...
  const code = raw.replace("__NUXT_SERVER_FETCH_URL__", `${protocol}://${host}:${port}/__nuxt_vite_node__/`).replace("__NUXT_SERVER_ENTRY__", entryPath).replace("__NUXT_SERVER_BASE__", ctx.ssrServer.config.base || "/_nuxt/");
